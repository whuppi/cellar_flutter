#!/bin/bash
# ============================================================================
# cellar_flutter secrets manager
#
# Manages secrets for whuppi/cellar_flutter ONLY.
...
REPO="whuppi/cellar_flutter"
BWS="${HOME}/bin/bws --color no"
BW_PREFIX="cellar_flutter"
...
case "${1:-}" in
    ...
    rm)     cmd_rm "$2" ;;
    *)
        echo "cellar_flutter secrets manager"
        echo ""
        echo "Usage:"
